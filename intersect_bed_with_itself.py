...
# Parse input params
parser = argparse.ArgumentParser('Generate a bedpe file from a bed where each region is anchored to itself.')
...
def bedpe_from_bed(file,outfile=None):
	...
	for line in f:
		...
		o.write(tabify([chr1,start1,end1,chr1,start1,end1]))
		ct+=1
